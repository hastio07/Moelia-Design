                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img alt="avatar" class="rounded-circle img-fluid" src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp" style="width: 150px;">
                            <h5 class="my-3">John Smith</h5>
                            <p class="text-muted mb-1">Super Admin</p>
                            <div class="justify-content-center mb-2 mt-4">
                                <button class="btn btn-primary" type="button"><i class="bi bi-pencil-square"></i> Ubah Biodata</button>
                            </div>
                        </div>
                    </div>
                </div>
