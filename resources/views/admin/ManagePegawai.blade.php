                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-modal mb-2 mt-3">
                            <button class="btn icon-left btn-success mb-2" data-bs-route="{{ route('manage-pegawai.store') }}" data-bs-target="#CUModal" data-bs-toggle="modal" id="btnCreateModal" type="button"><i class="bi bi-plus-lg"></i>Tambah Pegawai</i></button>
                        </div>
                    ...
                    <form enctype="multipart/form-data" id="CUForm" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-5 p-3">
                                ...
                                <div class="d-flex mt-3 rounded border p-1">
                                    <p class="mb-0 ms-2">Apakah akan ditampilkan di halaman depan?</p>
                                    <div class="form-check mx-3">
                                        <input class="form-check-input" id="flexRadioDefault1" name="show_data" type="radio" value="ya">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" id="flexRadioDefault2" name="show_data" type="radio" value="tidak">
