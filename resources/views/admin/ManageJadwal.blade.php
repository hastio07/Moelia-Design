            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-modal mt-3 mb-2">
                        <button class="btn mb-2 icon-left btn-success" data-bs-route="{{ route('manage-jadwal.store') }}" data-bs-target="#jadwalModal" data-bs-toggle="modal" id="create-button" type="button"><i class="bi bi-plus-lg"></i>Tambah Jadwal</button>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn mb-2 icon-left  btn-success" form="jadwalForm" name="submit" type="submit"><i class="ti-plus"></i>Tambah</button>
                </div>
            </div>
        </div>
    </div>
