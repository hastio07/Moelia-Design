...
<section class="">
    <div class="card p-3">
        <div class="btn-modal">
            <button class="btn mb-2 icon-left  btn-success" data-bs-route="" data-bs-target="#CUModal" data-bs-toggle="modal" id="btnCreateModal" type="button"><i class="bi bi-plus-lg"></i>Tambah Data</i></button>
        </div>
        <div class="row mt-2">
            <div class="col-md-4">
                <div class="all-in-paket">
                    <div class="card p-4">
                        ...
                        <table class="table display mt-2" id="table-admins">
                            <thead>
                                <tr>
                                    <th>Nama Paket</th>
                                    <th>Harga</th>
