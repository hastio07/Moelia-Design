                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="bg-body h-100 container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('nama_owner') || $errors->has('kata_sambutan') ||
                                                $errors->has('foto_owner') || $errors->has('oldfoto_owner'))
                                                <div class="m-3 pt-1">
                                                ...
                                                <form action="{{ route('manage-perusahaan.updateorcreateowner') }}" class="formstyle" enctype="multipart/form-data" id="formOwner" method="POST">
                                                    ...
                                                    <div class="flex-item button">
                                                        <div class="d-grid d-md-flex justify-content-md-center gap-2">
                                                            ...
                                                            @if (!empty($owners) && ($owners->nama_owner ||
                                                            $owners->foto_owner || $owners->kata_sambutan))
                                        ...
                                        <div class="col-md-5">
                                            <div class="left bg-body h-100 mb-3 rounded border bg-white p-3 text-center shadow">
                                                ...
                                                @if (!empty($owners->foto_owner) || !empty($owners->kata_sambutan) ||
                                                !empty($owners->nama_owner))
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="bg-body container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('nama_perusahaan') || $errors->has('logo_perusahaan')
                                                || $errors->has('oldlogo_perusahaan'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                                ...
                                                <form action="{{ route('manage-perusahaan.updateorcreatecompany') }}" class="formstyle" enctype="multipart/form-data" id="formCompany" method="POST">
                                                    ...
                                                    <div class="flex-item button">
                                                        <div class="d-grid d-md-flex justify-content-md-center gap-2">
                                                            <button class="btn btn-success" type="submit">Upload</button>
                                                            @if (!empty($companies) && ($companies->nama_perusahaan ||
                                                            $companies->logo_perusahaan))
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="bg-body h-100 container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('judul-video-promosi') ||
                                                $errors->has('link-video-promosi'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                                ...
                                                <form action="{{ route('manage-perusahaan.updateorcreatevideopromosi') }}" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <div class="mt-3 text-center">
                                                        <button class="btn btn-success" type="submit">Upload</button>
                                                        @if (!empty($videopromosi) && ($videopromosi->judul ||
                                                        $videopromosi->link_video))
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-5">
                                            <div class="h-100 rounded border p-3 shadow">
                                                ...
                                                <div class="border rounded bg-danger text-white p-3">
                                                    <h6 class="fw-bold text-center mb-2">Cara Upload Link Maps !!</h6>
                                                    <ol>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="bg-body h-100 container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('telephone1_name') ||
                                                $errors->has('telephone1_number') || $errors->has('telephone2_name') ||
                                                $errors->has('telephone2_number') || $errors->has('whatsapp1_name') ||
                                                $errors->has('whatsapp1_number') || $errors->has('whatsapp2_name') ||
                                                $errors->has('whatsapp2_number') || $errors->has('whatsapp3_name') ||
                                                $errors->has('whatsapp3_number') || $errors->has('whatsapp4_name') ||
                                                $errors->has('whatsapp4_number') || $errors->has('email'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                                ...
                                                <form action="{{ route('manage-perusahaan.updateorcreatecontact') }}" class="formstyle" enctype="multipart/form-data" id="formContact" method="POST">
                                                    <div class="flex-item form">
                                                        ...
                                                        <label class="form-label fw-bold mt-4" for="whatsapp1">Whatsapp 1</label>
                                                    ...
                                                    <div class="flex-item button">
                                                        <div class="d-grid d-md-flex justify-content-md-center gap-2">
                                                            <button class="btn btn-success" type="submit">Upload</button>
                                                            @php
                                                            $kontak = ['telephone1_name', 'telephone1_number',
                                                            'telephone2_name', 'telephone2_number', 'whatsapp1_name',
                                                            'whatsapp1_number', 'whatsapp2_name', 'whatsapp2_number',
                                                            'whatsapp3_name', 'whatsapp3_number', 'whatsapp4_name',
                                                            'whatsapp4_number', 'email'];
                                                            $show_button = false;
                                                ...
                                                <div class="my-4">
                                                    <div class="p4 rounded border p-3 shadow">
                                                        ...
                                                        <ol style="margin-left: 2.3rem; padding-left: 2.1rem;">
                                                            @if (!empty($contacts))
                                                            @php
                                                            $data_contact_telephone = [['name' =>
                                                            $contacts->telephone1_name, 'number' =>
                                                            $contacts->telephone1_number], ['name' =>
                                                            $contacts->telephone2_name, 'number' =>
                                                            $contacts->telephone2_number]];
                                                            @endphp
                                                            @foreach ($data_contact_telephone as $contact)
                                                            @if ($contact['name'] || $contact['number'])
                                                            <li>{{ $contact['number'] ?? null }} ({{ $contact['name'] ??
                                                                null }})</li>
                                                            @endif
                                                            @endforeach
                                                            @endif
                                                ...
                                                <div class="p4 rounded border p-3 shadow">
                                                    <div class="mb-4">
                                                        ...
                                                        <ol style="margin-left: 2.3rem; padding-left: 2.1rem;">
                                                            @if (!empty($contacts))
                                                            @php
                                                            $data_contact_whatsapp = [['name' =>
                                                            $contacts->whatsapp1_name, 'number' =>
                                                            $contacts->whatsapp1_number], ['name' =>
                                                            $contacts->whatsapp2_name, 'number' =>
                                                            $contacts->whatsapp2_number], ['name' =>
                                                            $contacts->whatsapp3_name, 'number' =>
                                                            $contacts->whatsapp3_number], ['name' =>
                                                            $contacts->whatsapp4_name, 'number' =>
                                                            $contacts->whatsapp4_number]];
                                                            @endphp
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="bg-body h-100 container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('u_instagram') || $errors->has('l_instagram') ||
                                                $errors->has('u_facebook') || $errors->has('l_facebook') ||
                                                $errors->has('u_twitter') || $errors->has('l_twitter') ||
                                                $errors->has('u_tiktok') || $errors->has('l_tiktok') ||
                                                $errors->has('u_youtube') || $errors->has('l_youtube'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                                    ...
                                                    <div class="flex-item form">
                                                        ...
                                                        <div class="flex-item button">
                                                            <div class="d-grid d-md-flex justify-content-md-center gap-2">
                                                                ...
                                                                @php
                                                                $social_media = ['u_instagram', 'l_instagram',
                                                                'u_facebook', 'l_facebook', 'u_twitter', 'l_twitter',
                                                                'u_youtube', 'l_youtube', 'u_tiktok', 'l_tiktok'];
                                                                $show_button = false;
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="bg-body h-100 container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('katasambutan') || $errors->has('judul_siapa') ||
                                                $errors->has('fotobersama') || $errors->has('oldfotobersama'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                                ...
                                                <form action="{{ route('manage-perusahaan.updateorcreateabout') }}" class="formstyle" enctype="multipart/form-data" id="formAbout" method="POST">
                                                    ...
                                                    <div class="mt-2 text-center">
                                                        <button class="btn btn-success" type="submit">Upload</button>
                                                        @if (!empty($abouts) && ($abouts->katasambutan ||
                                                        $abouts->fotobersama || $abouts->judul))
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="bg-body h-100 container mb-3 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('penawaran') || $errors->has('foto_bersama') ||
                                                $errors->has('oldfoto_bersama'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-7">
                                            <div class="h-100 rounded border p-3 shadow">
                                                ...
                                                @endif
                                                @if ($errors->has('pengantar') || $errors->has('foto_sertifikat') ||
                                                $errors->has('oldfoto_sertifikat'))
                                                <div class="m-3 pt-1">
                                                    <div class="alert alert-danger">
                                                        <ul style="list-style:none;">
                                                            @foreach ($errors->all() as $message)
                                                ...
                                                <div class="row px-3">
                                                    <div class="col-sm-2">
                                                        <div class="form-check form-switch me-5">
                                                            <input @checked(old(false, $value->status_format))
                                                            class="form-check-input" id="switch{{ $i }}" name="day[{{
                                                            $value->id }}][]" role="switch" type="checkbox"
                                                            value="true">
                                                    ...
                                                    <div class="col-sm-7 d-flex time">
                                                        <div class="mob">
                                                            ...
                                                            <input class="ml-1" id="from{{ $i }}" name="from[{{ $value->id }}][]" type="time" value={{
                                                                old('', $value->time_from_format) }}>
                                                        </div>
                                                        <div class="mob mb-2">
                                                            <label class="mr-4" for="to{{ $i }}">To</label>
                                                            <input class="ml-1" id="to{{ $i }}" name="to[{{ $value->id }}][]" type="time" value={{
                                                                old('', $value->time_to_format) }}>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
