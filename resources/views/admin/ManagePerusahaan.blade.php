                                    ...
                                    <div class="col-md-4">
                                        <div class="wrapper-list mt-3">
                                            ...
                                            <div class="left bg-body mb-3 rounded border bg-white p-3 text-center shadow">
                                                ...
                                                @else
                                                    <p class="text-danger mt-3">-- Logo dan Nama Perusahaan Harap di Isi --</p>
                                                @endif
                                            </div>

                                            <!-- output vidio promosi -->
                                            <div class="left vidio-pro bg-body mb-3 rounded border bg-white p-3 text-center shadow">
                                                <h4>Vidio Promosi</h4>
                                                @if (!empty($videopromosi->judul) || !empty($videopromosi->link_video))
                                                    <div class="mt-3">
                                                        ...
                                                        <!-- <iframe allowfullscreen class="embed-responsive-item rounded" src="https://www.youtube.com/embed/{{ $videopromosi->link_video }}"></iframe> -->
                                                    </div>
                                                @endif
                                            </div>

                                            <!-- output alamat, kontak & sosmed -->
                                            <div class="left bg-body mb-3 rounded border bg-white p-3 shadow">
                                                <div class="mt-3 mb-4">
