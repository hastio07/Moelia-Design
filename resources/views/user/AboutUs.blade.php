    ...
    <div class="container mt-3 rounded border">
        <div class="row">
            <div class="col-md-4 d-flex justify-content-center align-items-center container">
                ...
                @else
                <p class="text-center bg-danger rounded p-3 border text-white fw-bold">Harap Upload <a class="text-info text-decoration-underline" href="/manage-perusahaan"> Foto Sertifikat !!</a> !!</p>
                @endif
            </div>
