...
<head>
    ...
    <link href="{{ asset('templates') }}/assets/css-modif/UserMaintenance.css" rel="stylesheet">
...
<body>
    <div class="wrapper text-center">
        ...
        <p>maaf menu ini sedang dalam masa perbaikan</p>
        <div class="icons">
            <a href="/">
                <button class="btn btn-primary">Home<i class="bi bi-box-arrow-up-right ms-2"></i></button>
            </a>
        </div>
    </div>
</body>
