                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                                    ...
                                                    {{-- <form action="{{ route('manage-akun.destroy', $hashids->encode($admin->id)) }}" class="d-inline" id="form-delete-{{ $i++ }}" method="post">
                                                        @method('delete')
                                                        @csrf
                                                        <button class="btn btn-danger" form="form-delete" type="submit"><i class="bi bi-trash"></i></button>
                                                    </form> --}}
