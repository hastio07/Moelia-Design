                                ...
                                <div class="col-md-8">
                                    <div class="wrapper-list">
                                        ...
                                        <div class="container border mt-3 shadow p-3 mb-5 bg-body rounded">
                                            ...
                                            <form action="{{ route('manage-perusahaan.updateorcreateowner') }}" class="formstyle" enctype="multipart/form-data" id="formOwner" method="POST">
                                                <div class="flex-item form">
                                                    ...
                                                    <label for="exampleFormControlTextarea1" class="form-label">Kata Sambutan</label>
                                        ...
                                        <div class="container border mt-3 shadow p-3 mb-5 bg-body rounded">
                                            ...
                                            <form action="{{ route('manage-perusahaan.updateorcreateaddress') }}" class="formstyle" enctype="multipart/form-data" id="formAlamat" method="POST">
                                                <div class="flex-item form">
                                                    ...
                                                    <label class="form-label" for="telephone_1">Link Google Maps</label>
                                                    <input class="form-control" type="text" placeholder="Link Google Maps" aria-label="default input example">
                                                </div>
                                                <div class="flex-item button">
                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                                        <button class="btn btn-success" type="submit">Upload</button>
                                        ...
                                        <div class="container border mt-3 shadow p-3 mb-5 bg-body rounded">
                                            ...
                                            <form action="{{ route('manage-perusahaan.updateorcreatcontact') }}" class="formstyle" enctype="multipart/form-data" id="formContact" method="POST">
                                                <div class="flex-item form">
                                                    ...
                                                    <label class="form-label" for="telephone_1">Telephone</label>
                                                    <input class="form-control" id="telephone_1" name="telephone_1" placeholder="Masukkan nomor telephone" type="text" value="{{ $contacts->telephone_1 ?? '' }}">
                                                    <label class="form-label" for="whatsapp_1">Whatsapp</label>
                                                    <input class="form-control" id="whatsapp_1" name="whatsapp_1" placeholder="Masukkan nomor whatsapp" type="text" value="{{ $contacts->whatsapp_1 ?? '' }}">
                                        ...
                                        <div class="container border mt-3 shadow p-3 mb-5 bg-body rounded">
                                            ...
                                            <form action="{{ route('manage-perusahaan.updateorcreatsosmed') }}" class="formstyle" enctype="multipart/form-data" id="formSosmed" method="POST">
                                                <div class="flex-item form">
                                                    ...
                                                    <input class="form-control mt-1" id="instagram" name="instagram" placeholder="Masukkan link instagram" type="text" value="">
                                                    ...
                                                    <input class="form-control mt-1" id="facebook" name="instagram" placeholder="Masukkan link Facebook" type="text" value="">
                                        ...
                                        <div class="container border mt-3 shadow p-3 mb-5 bg-body rounded">
                                            ...
                                            <label for="exampleFormControlTextarea1" class="form-label">Kata Sambutan</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                            <label class="form-label" for="">Foto Bersama</label>
                                            <input accept="image/jpg, image/png, image/jpeg" class="form-control" id="logo" name="logo_perusahaan" type="file">
                                            <div class="mt-2 text-center">
                                                <button class="btn btn-success" type="submit">Upload</button>
                                                <button class="btn btn-danger" data-bs-route="" id="btnDelete" type="submit">hapus</button>
                                            </div>
                                        </div>
                                        <div class="container border mt-3 shadow p-3 mb-5 bg-body rounded">
                                            <h5 class="text-center">
                                            ...
                                            <label class="form-label" for="">Foto Bersama</label>
                                            <input accept="image/jpg, image/png, image/jpeg" class="form-control mb-3" id="logo" name="logo_perusahaan" type="file">
                                            <textarea id="penawaran" name="penawaran"></textarea>
                                            <div class="mt-2 text-center">
                                                <button class="btn btn-success" type="submit">Upload</button>
                                                <button class="btn btn-danger" data-bs-route="" id="btnDelete" type="submit">hapus</button>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="left border bg-white shadow p-3 mb-5 bg-body rounded">
                                        ...
                                        <div class="d-flex mt-3">
                                            ...
                                            <p>{{ $contacts->telephone_1 ?? '' }}</p>
                                        </div>
                                        <div class="d-flex mt-3">
                                            <i class="fa-brands fa-whatsapp fa-2xl"></i>
                                            <p>{{ $contacts->whatsapp_1 ?? '' }}</p>
                                        </div>
                                        <div class="d-flex mt-3"> <i class="fa-brands fa-instagram fa-2xl"></i>
                                            <p>{{ $sosmeds->instagram ?? '' }}</p>
                                        </div>
                                        <div class="d-flex mt-3">
                                            <i class="fa-brands fa-facebook fa-2xl"></i>
                                            <p>{{ $sosmeds->facebook ?? '' }}</p>
                                        </div>
                                        <div class="d-flex mt-3">
